...
public class ProcessService {
  ...
  public static boolean addProcess1(Process1DTO process1) throws SQLException{
    return Process1DAO.addProcess1(process1);
  }

  //process1 삭제
  public static boolean deleteProcess1(int waferId) throws NotExistException, SQLException{
    notExistSemi1(waferId);
    return Process1DAO.deleteProcess1(waferId);
  }
  ...
  //Process2 저장
  public static boolean addProcess2(Process2DTO Process2) throws SQLException{
    return Process2DAO.addProcess2(Process2);
  }
